...
void road()
{
    ...
    glColor3f(0.0,0.407843,0.03921568);
...
//blood
    ...
    //right hand
    glPushMatrix();
    glTranslatef(-0.5,.9,-.4);
	  // init();
    glColor3f(1,1,1);
    //light_red();
    glRotatef(160,0,01,01);
    glScalef(.08,.08,3.1);
    glutSolidTorus(.25,.5,100,100);
    //glDisable(GL_LIGHT0);
    glPopMatrix();
...
void checkCollision()
{
    ...
    if((car2Z ==94 && moveUfo >= car2X-1.5 && moveUfo <= car2X+1.5 ) && !pause )
    {
        LIFE -= 9;
        cout << "SCORE = " << SCORE<<endl;
        cout << "LIFE = " << LIFE<<endl;
    ...
    if((car3Z ==94 && moveUfo >= -2*car3X-1.5 && moveUfo <= -2*car3X+1.5 ) && !pause )
    {
        LIFE -= 9;
        cout << "SCORE = " << SCORE<<endl;
        cout << "LIFE = " << LIFE<<endl;
    ...
    if(( heal && zex == 0 && (moveUfo >- heal_check && moveUfo < heal_check) && heal_check == 1 ) && !pause )
    {
       // pause = true;
        heal = false;
        LIFE += 10;
    ...
    else if(( heal && zex == 0 && (moveUfo <-4 && moveUfo > -5)  && heal_check == 2) && !pause )
    {
       // pause = true;
        heal = false;
        LIFE += 15;
...
void drawScene()
{
    ...
    glClearColor (0.529411765,0.807843137,0.980392,0.0);
...
int main(int argc, char** argv)
{
    ...
    //Create the window
    glutCreateWindow("Zoombie Shooter");
    initRendering();
